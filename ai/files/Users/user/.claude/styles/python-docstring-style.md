...
- Multi-line frame: `"""` opens on its own line, `"""` closes on its own line. Preserve this frame when editing an existing multi-line docstring; never collapse to a one-liner.
