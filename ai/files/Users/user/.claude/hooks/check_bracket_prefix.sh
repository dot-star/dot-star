...
reason+=$'\nRewrite each alternative as **`[x]remainder`** (case-insensitive accept letter, wrapped in bold inline code), then re-send. See the pre-send checklist in CLAUDE.md.'
